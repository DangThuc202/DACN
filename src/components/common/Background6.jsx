    ...
    return (
        <Box sx={{ height: "50vw", display: "flex" }}>
            ...
            <Box sx={{ position: "absolute", right: 0, marginRight: "40px", marginTop: "150px" }}>
                <Typography variant="h3" style={{ fontWeight: 500, marginBottom: "40px" }}>Tư vấn sức khỏe từ xa 24/7 <br /> qua video & chat</Typography>
                <Typography sx={{ fontSize: "18px" }}>Bạn cần sự tư vấn chuyên môn khi gặp các vấn đề sức khỏe? Dù bạn ở <br /> đâu hay vào bất cứ lúc nào, các bác sĩ chuyên khoa của Jio Health luôn <br /> sẵn sàng tư vấn, giải đáp đáp mọi thắc mắc của bạn.</Typography>
