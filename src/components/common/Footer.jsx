    ...
    <Box sx={{ backgroundColor: '#242a61', color: 'white', padding: '85px 150px' }}>
      ...
      <Box sx={{ marginTop: '30px', display: 'flex' }}>
        ...
        <Box sx={{ padding: '0 30px' }}>
          <Stack spacing={1}>
            <Typography sx={{ display: 'flex', fontWeight: '700' }}>Dịch vụ</Typography>
            <Typography sx={{ display: 'flex' }}>
        ...
        <Box sx={{ padding: '0 30px' }}>
          <Stack spacing={1}>
            <Typography sx={{ display: 'flex', fontWeight: '700' }}>Tìm hiểu thêm</Typography>
            <Typography sx={{ display: 'flex' }}>
        ...
        <Box sx={{ padding: '0 30px' }}>
          <Stack spacing={1}>
            <Typography sx={{ display: 'flex', fontWeight: '700' }}>Hỗ trợ khách hàng</Typography>
            <Typography sx={{ display: 'flex' }}>
            ...
            <Typography sx={{ display: 'flex', marginBottom: '20px' }}>
              <Typography style={{ marginBottom: '30px' }} sx={styleTypo}>
      ...
      <Box sx={{ marginTop: '30px', display: 'flex' }}>
        <Box sx={{ width: '470px', marginRight: '60px' }}>
          <Stack spacing={1}>
            <Typography sx={{ display: 'flex' }}>CÔNG TY TNHH PHÒNG KHÁM ĐA KHOA JIO HEALTH</Typography>
            <Typography sx={{ display: 'flex' }}>
              Giấy CN ĐKDN số 0309145924, đăng ký lần đầu ngày 06/07/2009, đăng ký thay đổi lần thứ 9 ngày 06/07/2023,
              cấp bởi Sở KH&ĐT Thành phố Hồ Chí Minh.
            </Typography>
          </Stack>
        </Box>
        <Box sx={{ padding: '0 30px' }}>
          <Stack spacing={1}>
            <Typography sx={{ display: 'flex', fontWeight: '700' }}>Địa chỉ</Typography>
            <Typography sx={{ display: 'flex' }}>
              Phòng khám Đa khoa Cao cấp Jio Health - Jio Smart <br />
              Clinic
            </Typography>
            <Typography sx={{ display: 'flex' }}>39 Lê Duẩn, Phường Bến Nghé, Quận 1, TP.HCM</Typography>
            <Typography sx={{ display: 'flex' }}>Hãy theo dõi Jio Health tại</Typography>
