...
const ChangePassword = ({ switchAuthState }) => {
  ...
  const changePassword = useFormik({
    ...
    validationSchema: Yup.object({
      username: Yup.string().min(0, 'Tên đăng nhập không được để trống').required('Trường này là bắt buộc'),
      password: Yup.string().min(0, 'Password không được để trống').required('Trường này là bắt buộc'),
      newPassword: Yup.string().min(0, 'Password không được để trống').required('Trường này là bắt buộc'),
    ...
    <Box component="form" onSubmit={changePassword.handleSubmit}>
      <Stack spacing={3}>
        ...
        <TextField
          ...
          error={changePassword.touched.username && changePassword.errors.username !== undefined}
        ...
        <TextField
          ...
          onChange={changePassword.handleChange}
          color="success"
          error={changePassword.touched.password && changePassword.errors.password !== undefined}
        ...
        <TextField
          ...
          onChange={changePassword.handleChange}
          error={changePassword.touched.newPassword && changePassword.errors.newPassword !== undefined}
        ...
        <TextField
          ...
          onChange={changePassword.handleChange}
          error={changePassword.touched.confirmNewPassword && changePassword.errors.confirmNewPassword !== undefined}
          helperText={changePassword.touched.confirmNewPassword && changePassword.errors.confirmNewPassword}
        />
      </Stack>

      <Button type="submit" fullWidth size="large" variant="contained" sx={{ marginTop: 4 }} loading={isLoginRequest}>
        Đổi mật khẩu
      </Button>
