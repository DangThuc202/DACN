...
const Pay = () => {
    ...
    return (
        <Box margin="50px 146px">
            <Typography sx={{ color: "#111C63", fontSize: "36px", fontWeight: "700" }}>Phương pháp thanh toán linh hoạt</Typography>
            <Typography sx={{ fontSize: "20px", margin: "30px 0" }}>Chúng tôi cũng cung cấp các lựa chọn trả góp linh hoạt để đảm bảo khả năng chi trả của khách hàng cho các dịch vụ chăm sóc cao cấp.</Typography>
