    ...
    return (
        <Box sx={{ height: "35vw", display: "flex" }}>
            ...
            <Box sx={{ marginLeft: "100px", paddingTop: "130px" }}>
                <Typography style={{ fontWeight: 600, paddingBottom: "40px" }} variant="h2">Thông tin sức khỏe dành <br />cho bạn</Typography>
                <Typography style={{ fontSize: "18px" }}>
                    360 độ nội dung sức khỏe thuộc các chủ đề được nhiều người quan tâm <br /> hiện nay, dưới  sự xây dựng từ các chuyên gia sức khỏe tại Jio Health.
                </Typography>
                <Typography sx={{ fontSize: "18px", paddingTop: "30px" }}>
                    Cần xem thêm nhiều bài viết chuyên khoa thú vị khác ?
                    <a style={{ color: "red" }} href="#"> Blog Jio Health </a>
