  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Box sx={{ textAlign: 'center', marginBottom: '2rem', width: '400px' }}></Box>

          {action === actionStates.login && (
            <Login switchAuthState={() => switchAuthState(actionStates.changePassword)} />
          )}
          {action === actionStates.changePassword && (
            <ChangePassword switchAuthState={() => switchAuthState(actionStates.login)} />
          )}
        </Box>
      </Box>
    </Box>
