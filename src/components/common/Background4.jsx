    ...
    <Box sx={{ position: 'relative', color: 'white' }}>
      ...
      <Box sx={{ position: 'absolute', top: '12%', left: '10%', right: '10%' }}>
        ...
        <Typography sx={{ fontSize: '20px', marginTop: '50px' }}>
          Jio Health hiện đang liên kết với 40+ doanh nghiệp bảo hiểm lớn và uy tín nhằm mang đến cho khách hàng dịch vụ
          chăm sóc sức khỏe chất lượng với chi phí hợp lý.
        </Typography>
