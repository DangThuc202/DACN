    ...
    return (
        <Box sx={{
            ...
            <Box sx={{ paddingLeft: "14px" }}>
                <Typography variant="h5" sx={{ padding: "16px 0", fontWeight: 600 }} >Q2 Thao Dien</Typography>
                ...
                >
                    ...
                    2 Võ Trường Toản, Thảo Điền, Quận 2,<br />TP.HCM
                </Typography>
                ...
                <Button variant="contained" style={BtnStyle} sx={{
